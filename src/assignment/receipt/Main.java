...
public class Main {
    public static void main(String[] args) {
        ...
        List <assignments.receipt.Receipt> receipts = new ArrayList<>();
        ...
        do {
            ...
            try {
                ...
                receipts.add(new assignments.receipt.Receipt(itemBought,quantity,pricePerUnit,total));
        ...
        if(billTotal == 0){
            ...
            for (assignments.receipt.Receipt receipt:receipts) {
